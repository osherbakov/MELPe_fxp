...
//			else if (uv_index == 5)
//		    	qpar->pitch_index = (int16_t) (qpar->pitch_index + PITCH_VQ_SIZE);
//		} else {
...
//			qpar->uv_flag[1] = par[1].uv_flag = 0;
//			qpar->uv_flag[2] = par[2].uv_flag = 0;
//			qpar->pitch_index = (int16_t) (qpar->pitch_index + 2*PITCH_VQ_SIZE);
//		} else {
//		    if (prot_bp1 == 2){
//		    	qpar->uv_flag[0] = par[0].uv_flag = 0;
//				qpar->uv_flag[1] = par[1].uv_flag = 1;
...
//			qpar->uv_flag[1] = par[1].uv_flag = 0;
//			qpar->uv_flag[2] = par[2].uv_flag = 0;
//			qpar->pitch_index = (int16_t) (qpar->pitch_index + 3*PITCH_VQ_SIZE);
//		} else {
//			erase_vvv |= 1;
//			qpar->pitch_index = (int16_t) (qpar->pitch_index + 3*PITCH_VQ_SIZE);
//		}
